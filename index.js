...
let queryResponse = [
  ...
  },
  {
    ...
    map:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3803.0197610165824!2d78.48535181441314!3d17.601796487950413!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb85fab149cbb5%3A0x8a587e9e64725dcd!2sCMR%20Engineering%20College!5e0!3m2!1sen!2sin!4v1647697662321!5m2!1sen!2sin"
  },
  {
  ...
  },
  {
    ...
    hlink: [
      { link: "http://wa.me/+919248727229", text: "+91 9248727229" },
      { link: "mailto:info@cmrec.ac.in", text: "send mail" }
    ]
  },
  {
    question: "Fee enquiry?",
    answer:
      "Online mode:: login into student portal... Offline mode:: contact AO chamber",
  ...
  },
  {
    ...
    hlink: [
      {
        link:
          "https://www.collegedekho.com/colleges/cutoff-cmr-engineering-college",
        text: "Cutoff for CMREC"
      }
    ]
  },
  {
    question: null,
    answer: "Here are the list of questions I can answer:",
  },
  {
    question: null,
    answer:
  ...
  },
  {
    ...
    rand: [
      ...
      "Hello, you can click on a button from question menu to get the answer.",
      "Hi!",
      "Wassup!",
      "Hello!"
    ]
...
//booked
function init(){
  log(queryResponse[10].answer, "message bot");
  log(queryResponse[9].answer, "message bot");
  buttongen();
}
